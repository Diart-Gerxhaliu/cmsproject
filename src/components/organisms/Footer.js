            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-6 text-lg-center">
                <ul className="list-unstyled nav-links nav-left mb-4 mb-lg-0">
                  {menu.map((gal,index)=>{
                        return <li key={index}><Link to={gal.href}>{gal.child}</Link></li>
                    })}
                </ul>
              </div>
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-4 text-lg-center site-logo order-1 order-lg-2 mb-3 mb-lg-0">
              <Link href="#" className="m-0 p-0">Colorlib</Link>
            </div>            
            <div className="col-lg-4 text-lg-right order-3 order-lg-3">
              <p className="m-0 text-muted"><small>&copy; 2019. All Rights Reserved.</small></p>
            </div>
          </div>
        </div>
